...
def initialize(context):
    ...
    g.FACTOR_SPECS = [
        ...
        {'name': 'low_ps', 'source': 'valuation', 'column': 'ps_ratio', 'direction': -1, 'weight': 0.06,
         'desc': '低PS，金融股中性'},
        {'name': 'divyild', 'source': 'jqfactor', 'column': 'divyild', 'direction': +1, 'weight': 0.10,
         'desc': '股息率/红利因子'},
        ...
        {'name': 'earnqlty', 'source': 'jqfactor', 'column': 'earnqlty', 'direction': +1, 'weight': 0.05,
         'desc': '盈利质量风格因子'},
        {'name': 'profit', 'source': 'jqfactor', 'column': 'profit', 'direction': +1, 'weight': 0.04,
         'desc': '盈利能力风格因子'},
        ...
        {'name': 'Variance120', 'source': 'jqfactor', 'column': 'Variance120', 'direction': -1, 'weight': 0.04,
         'desc': '120日收益方差，低波'},
        {'name': 'resvol', 'source': 'jqfactor', 'column': 'resvol', 'direction': -1, 'weight': 0.03,
         'desc': '残余波动率，越低越稳'},
