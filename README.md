...
**v1 核心策略**：五因子选股组合（低换手 / 低PB / 高股息 / E/P / 低PS），Top8 双周调仓 + 行业≤3 约束（本地回测 2023-2026 +35.02%，夏普 0.98；**聚宽在线平台 2020-2026 全周期复现 +35.33% / 年化 4.66% / 最大回撤 -26.81%，见 `reference/joinquant_v1_backtest_report.md`**；walk-forward 2023 +14.09% / 2024 +14.05% / 2025-26 -0.71%——**近期段未过样本外门，实盘/加仓需谨慎**）。
